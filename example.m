...
% Sample data used here comes from a simulation. sample_data.mat contains
% two variables, X and Y. X contains the activity in the source
% population. It's a N-by-p matrix, where N is the number of datapoints
% and p is the number of source neurons. Y contains the activity in the
% target population. It's a N-by-K matrix, where K is the number of target
% neurons. For the sample data, N = 4000, p = 100 and K = 30. The N
% datapoints can come from different time points or different trials. As
% an example, the 4000 datapoints used here could have come from 400
% trials that contained 10 time points each.
